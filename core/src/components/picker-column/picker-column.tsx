...
export class PickerColumnCmp {
  ...
  render() {
    ...
    if (col.prefix) {
      results.push(
        <div class='picker-prefix' style={{width: col.prefixWidth || '0px'}}>
          {col.prefix}
        </div>
      );
    }
    ...
    results.push(
      <ion-gesture
        ...
        attachTo='parent'
      ></ion-gesture>,
      <div class='picker-opts' style={{maxWidth: col.optionsWidth || '0px'}}>
        {options.map((o, index) =>
          <button
    ...
    if (col.suffix) {
      results.push(
        <div class='picker-suffix' style={{width: col.suffixWidth || '0px'}}>
          {col.suffix}
        </div>
      );
    }
